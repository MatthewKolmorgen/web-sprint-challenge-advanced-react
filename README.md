...
By using the keyword Super to be able to pass in "This" into a single object. Such as this.state = {}

2. Describe the different phases of the component lifecycle.
Mounting, Updating, Unmounting

3. Demonstrate an understanding of class component lifecycle methods.
Component did mount get's our api requests, 
Component did update will handle what is changing.
Componenet will unmount cleans up the stuff you don't need in the Dom

4. Define stateful logic.
Stateful components are always class components

5. Describe how to test a React component with React Testing Library.
To test I will typlically want to make sure I'm hitting all the required areas on the form/website/app to make sure everything is working how it's intended.
...
- [] Add your team lead as collaborator on Github (is this still applicable)
